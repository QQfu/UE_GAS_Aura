...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_HealthRegeneration, GetHealthRegenerationAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_ManaRegeneration, GetManaRegenerationAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_MinAttack, GetMinAttackAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_MaxAttack, GetMaxAttackAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_AbilityPower, GetAbilityPowerAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_CriticalHitChance, GetCriticalHitChanceAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_CriticalHitBonus, GetCriticalHitBonusAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_Amor, GetAmorAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_AmorPenetration, GetAmorPenetrationAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_Resistance, GetResistanceAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_ResistancePenetration, GetResistancePenetrationAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_BlockChance, GetBlockChanceAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_BlockBonus, GetBlockBonusAttribute);
	AttributeTagsToStaticFuncPtr.Add(AuraGameplayTags.Attributes_Secondary_CriticalHitResistance, GetCriticalHitResistanceAttribute);
